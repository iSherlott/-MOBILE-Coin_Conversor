...
const request = "https://api.hgbrasil.com/finance?format=json&key=b6fba862";
...
Widget buildTextField(
    String label, String prefix, TextEditingController value, Function status) {
  return TextField(
    controller: value,
